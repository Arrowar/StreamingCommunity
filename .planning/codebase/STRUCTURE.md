...
```
/Users/tcsenpai/StreamingCommunity/
...
│   │   └── MEGA.py
│   └── Util/
├── Video/                       # Default download output directory
│   └── Movie/
...
**conf/:**
- Purpose: Configuration files (not committed to git, downloaded from remote)
- Generated: No (manually maintained)
- Committed: Partially (template configs in GitHub, actual configs are local)

**Video/ (default output):**
- Purpose: Downloaded media storage (configurable)
- Generated: Yes (created by downloaders)
- Committed: No (ignored via .gitignore)

**Test/:**
- Purpose: Example scripts and test utilities
- Generated: No
- Committed: Yes

**.github/**
- Purpose: GitHub workflows and documentation
- Generated: No
- Committed: Yes

**.planning/ (GSD):**
- Purpose: Get Shit Done project planning artifacts
